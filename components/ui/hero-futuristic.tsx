...
export const HeroFuturistic = () => {
  const titleWords = 'AI Solutions Transformerar Framtiden'.split(' ');
  const subtitle = 'Skräddarsydda AI-lösningar för ditt företag - från automation till intelligenta agenter.';
  ...
  useEffect(() => {
    // Endast på klienten: genererar slumpmässiga fördröjningar för glitch-effekt
  ...
  return (
    <div className="h-svh relative">
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white font-bold normal-case max-w-4xl text-center">
          <div
